...
const Footer = () => {
  return (
    <div className="mt-10">
      <footer className=" footer-center p-4 bg-[#db4437]  text-white">
        <nav>
          <div className="text-xl font-bold text-white">
            <p>Be aHand</p>
            <img className='w-20 ml-[740px] items-center' src={logo} alt="" />
          </div>
        </nav>
        <nav>
        ...
        <aside className="text-xs">
          <p>Copyright © 2024 - All right reserved by be a hand Ltd</p>
        </aside>
      </footer>
    </div>
  );
